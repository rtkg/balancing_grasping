...
for i=1:n
    ...
    for j=1:m
       ...
       data.tf(i).transforms(j).translation = [tf{i}.Transforms(j).Transform.Translation.X; tf{i}.Transforms(j).Transform.Translation.Y; tf{i}.Transforms(j).Transform.Translation.Z];
